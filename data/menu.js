...
export const MainNavMenuItems = [
  {
    ...
    children: [
      {
        path: "/home/modern-video", title: "Home", type: "link"
      },
  ...
  },
  {
    ...
    type: "sub",
    children: [
      { path: "/listing/grid-view/slider", title: "Properties", type: "link" },
      // {
      //   title: "List View",
      //   type: "sub",
      //   children: [
  ...
  {
    title: "Project",
    icon: <Link to="/listing/grid-view/project"/>,
    type: "sub",
    children: [
      { path: "/listing/grid-view/project", title: "All Projects", type: "link" },
  ...
  {
    title: "Blog",
    icon: <Link to="/property/sticky-tab-or-classic"/>,
    type: "sub",
    children: [
      { path: "/property/sticky-tab-or-classic", title: "All Projects", type: "link" },
    ]
  },
  // {
  //   title: "PAGES",
  ...
  // },
  {
    ...
    type: "sub",
    children: [
      { path: "/agent/agent-grid", title: "Agents List", type: "link" },
