...
const PropertyBoxes = ({ data, relativeSlider }) => {
        ...
        <div className="property-box">
          ...
          <div className="property-details">
            ...
            <Link href={Array.isArray(data.img) ? `/property/image-slider/?id=${data.id}` : `/property/image-box/?id=${data.id}`}>
              <h3>{data.property_type} {data.property_starus} in {data.city}</h3>
            </Link>
            <h6>
              {symbol}
            ...
            <div className="property-btn d-flex">
              ...
              <Link href={Array.isArray(data.img) ? `/property/image-slider/${data.slug}` : `/property/image-box/${data.slug}`}>
