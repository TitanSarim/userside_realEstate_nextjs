...
const FeatureSection = ({ value, properties }) => {
  return (
          ...
          <Col>
            ...
            <NoSsr>
              <Slider className="feature-1 arrow-light" {...feature1}>
                {properties &&
                  properties.slice(0, 2).map((data, i) => (
                    <div key={i}>
                        ...
                        <Row>
                          <Col xl="4" lg="3">
                            <div className="feature-left">
                              <div className="property-details">
                                ...
                                <Link href={`/property/image-box/${data.slug}`}>
                                  <h3 className="d-flex">
                                    {data.property_type} {data.property_status} in {data.city}
                                    <span>
                          ...
                          <Col xl="8" lg="9" className="order-md">
                            <div className="feature-image">
                              <Img src={data.media[0].imageUrl} className="bg-img" />
                              <h4>{data.type}</h4>
